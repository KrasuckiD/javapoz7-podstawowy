...
public class CalendarApplication {
        ...
        do {
            ...
            switch (answer) {
                case 1:
                    ...
                    break;
                case 2:
                    calendarMonth = switchMonth1(scanner);
                    scanner.nextLine();
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    calendarMonth = prevMonth(calendarMonth);
                    scanner.nextLine();
                    break;
                default:
    ...
    private static CalendarMonth prevMonth(CalendarMonth calendarMonth) {
        int actuMonth = calendarMonth.getMonth();
        int prevYear = calendarMonth.getYear() + (actuMonth == 1 ? 1 : 0);
        int prevMonth = actuMonth == 1 ? 1 : actuMonth  -1;
        calendarMonth = CalendarMonth.ofMonth(prevYear, prevMonth);
    ...
    private static CalendarMonth switchMonth1(Scanner scanner) {
